...
export class MascotaHistoriaClinicaController {
  ...
  async create(
    ...
    return this.mascotaRepository.historiaClinicas(id).create(historiaClinica);
  }
  ...
  async patch(
    ...
    return this.mascotaRepository.historiaClinicas(id).patch(historiaClinica, where);
  }
  ...
  async delete(
    ...
    return this.mascotaRepository.historiaClinicas(id).delete(where);
  }
}
